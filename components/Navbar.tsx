      ...
      <div className="flex flex-1 items-center justify-between px-4 md:px-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/" className="hidden md:flex items-center space-x-3 group">
            ...
            <span className="text-xl font-bold font-syne text-ds-text-primary tracking-wide">DevSentinel AI</span>
          </Link>
        </div>
                ...
                <>
                  ...
                  >
                    <div className="px-4 py-3 border-b border-ds-border">
                      ...
                      <p className="text-xs text-ds-text-muted mt-0.5">admin@DevSentinel AI.ai</p>
                    </div>
                    <div className="py-1">
                      <a
                        href="/settings"
